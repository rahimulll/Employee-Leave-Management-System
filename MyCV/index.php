						...
						<ul>
							<li>
								<div class="li_wrap">
									...
									<div class="text">01787492460</div>
								</div>
							</li>
							<li>
								<div class="li_wrap">
									<div class="icon"><i class="fas fa-envelope" aria-hidden="true"></i></div>
									<div class="text">rahimul.emu@northsouth.edu</div>
								</div>
							</li>
							<li>
								<div class="li_wrap">
							...
							<li>
								<div class="li_wrap">
									...
									<div class="text">Bashundhara R/A, Block-D, Road-6</div>
								</div>
							</li>
						</ul>
					</div>
								...
								<li>
									<div class="li_wrap">
										...
										<div class="info">
											...
											<p class="info_cont">
												Working as a leader is my dream </br>
												Day by day learned something new 
											</p>
										</div>
									</div>
								</li>
								<li>
									<div class="li_wrap">
										...
										<div class="info">
											...
											<p class="info_com">
												Nitro webdev pvt Ltd
											</p>
											<p class="info_cont">
												Actively engaged in web creative design & development</br>
												Desining project & planing</br>
								...
								<li>
									<div class="li_wrap">
										...
										<div class="info">
											...
											<p class="info_cont">
												Gain professional skills</br>
												Project planing and demonstrated</br>
												Project analysis
											</p>
										</div>
									</div>
								...
								<li>
									<div class="li_wrap">
										...
										<div class="info">
											...
											<p class="info_cont">
												One of the best university all over the country</br>
												Well decorated environment</br>
												World class teaching policy</br>
								...
								<li>
									<div class="li_wrap">
										...
										<div class="info">
											...
											<p class="info_cont">
												One of the largest & historical college all over the country	
											</p>
										</div>
									</div>
								</li>
								<li>
									<div class="li_wrap">
										...
										<div class="info">
											...
											<p class="info_cont">
												The best place where I spent almost 10 years	
											</p>
										</div>
									</div>
								</li>
